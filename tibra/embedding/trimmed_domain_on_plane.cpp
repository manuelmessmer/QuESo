...
int TrimmedDomainOnPlane::FindIntersectingEdge(const Point2DType &rPoint, OrientationType Orientation) {
...
void TrimmedDomainOnPlane::SetSplitPoint(const Point2DType &rPoint, Orientation OrientationDest)
{
    // Take bool from Edge.

...
class TestGGQ1d(unittest.TestCase):
    ...
    def test_4(self):
        ...
        PolynomialDegree = 2
        for e in range(1,101):
            points = TIBRA_PythonApplication.IntegrationPointFactory.GetGGQ(PolynomialDegree, e, TIBRA_PythonApplication.IntegrationMethod.ReducedOrder1)
            p, r = 3, 0
            self.check_ggq_rules(points, p, r, e, 0.0, 1.0, True)
    ...
    def test_7(self):
        ...
        PolynomialDegree = 2
        for e in range(1,101):
            points = TIBRA_PythonApplication.IntegrationPointFactory.GetGGQ(PolynomialDegree, e, TIBRA_PythonApplication.IntegrationMethod.ReducedOrder2)
            p, r = 2, 0
            self.check_ggq_rules(points, p, r, e, 0.0, 1.0, True)
            if e > 1:
    ...
    def f2(self):
        ...
        points1 = TIBRA_PythonApplication.IntegrationPointFactory.GetGGQ(PolynomialDegree, e1, TIBRA_PythonApplication.IntegrationMethod.ReducedExact)
        #points2 = TIBRA_PythonApplication.IntegrationPointFactory.GetGGQ(PolynomialDegree, e2, TIBRA_PythonApplication.IntegrationMethod.ReducedOrder1)
        # i = 1

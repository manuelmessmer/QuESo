...
class TestStrainEnergySteeringKnuckleKratos(unittest.TestCase):
    def run_test(self, filename, tolerance):
        ...
        pytibra.Run()
        pytibra.RunKratosAnalysis("tibra/tests/steering_knuckle_kratos/KratosParameters.json")
    ...
    def test_1(self):
        self.run_test("tibra/tests/steering_knuckle_kratos/TIBRAParameters1.json", 10)

    def test_2(self):
        self.run_test("tibra/tests/steering_knuckle_kratos/TIBRAParameters2.json", 10)

    def test_3(self):
        self.run_test("tibra/tests/steering_knuckle_kratos/TIBRAParameters3.json", 2)

    def test_4(self):
        self.run_test("tibra/tests/steering_knuckle_kratos/TIBRAParameters4.json", 3)

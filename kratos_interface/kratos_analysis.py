...
class Analysis():
    ...
    """
    def __init__(self, settings, kratos_settings_filename, elements, boundary_conditions ):
        """
        ...
        Args:
            settings (Parameters): The settings for the analysis, including elements and boundary conditions.
            kratos_settings_filename (str): The path to the Kratos settings file in JSON format.
            elements (list): A list of elements (from QuESo) to be added to the model part.
            boundary_conditions (list): A list of boundary conditions (from QuESo) to be applied to the model.
        """
        self.model = KM.Model()

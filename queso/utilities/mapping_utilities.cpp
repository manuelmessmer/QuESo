...
PointType VoxelIndexing::PointFromGlobalToParam( const PointType& rGlobalCoord, const BoundingBoxType& rBoundXYZ, const BoundingBoxType& rBoundUVW){
...
PointType VoxelIndexing::PointFromParamToGlobal( const PointType& rLocalCoord, const BoundingBoxType& rBoundXYZ, const BoundingBoxType& rBoundUVW ) {
    const auto delta_xyz = Math::Subtract( rBoundXYZ.second,  rBoundXYZ.first );
    const auto delta_uvw = Math::Subtract( rBoundUVW.second,  rBoundUVW.first );

...
#ifndef VOXEL_INDEXING_UTILITIES_INCLUDE_H
#define VOXEL_INDEXING_UTILITIES_INCLUDE_H
 ...
 * @brief  Allows to access Voxels/Elements by index.
 ...
 * @class  VoxelIndexer
 * @author Manuel Messmer
* @brief  Allows to access Voxels/Elements by index. Non-Static interface.

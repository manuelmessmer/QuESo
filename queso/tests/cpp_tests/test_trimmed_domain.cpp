...
BOOST_AUTO_TEST_CASE(TrimemdDomainElephantTest) {
    ...
    std::ifstream file("queso/tests/cpp_tests/results/surface_integral_elephant.txt");
    std::string line{};
...
BOOST_AUTO_TEST_CASE(TrimmedDomainBunnyTest) {
    ...
    std::ifstream file("queso/tests/cpp_tests/results/surface_integral_bunny.txt");
    std::string line{};
...
BOOST_AUTO_TEST_CASE(TestTrimmedDomainCylinderTest) {
    ...
    std::ifstream file("queso/tests/cpp_tests/results/surface_integral_cylinder.txt");
    std::string line{};

...
BOOST_AUTO_TEST_CASE(TestRegisterKeys1) {
    ...
    /// TestKeys1
    QuESo_CHECK_EQUAL(TestKeys1::zero.Index(), 0);
    QuESo_CHECK_EQUAL(TestKeys1::one.Index(), 1);    
    QuESo_CHECK_EQUAL(TestKeys1::two.Index(), 2);  
    QuESo_CHECK_EQUAL(TestKeys1::three.Index(), 3);
    QuESo_CHECK_EQUAL(TestKeys1::four.Index(), 4);    

    QuESo_CHECK_EQUAL( TestKeys1::zero.Name(), "zero");
    QuESo_CHECK_EQUAL( TestKeys1::one.Name(), "one");
    QuESo_CHECK_EQUAL( TestKeys1::two.Name(), "two");
    QuESo_CHECK_EQUAL( TestKeys1::three.Name(), "three");
    QuESo_CHECK_EQUAL( TestKeys1::four.Name(), "four");

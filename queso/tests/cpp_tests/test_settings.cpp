...
BOOST_AUTO_TEST_CASE(SettingsWrongTypeTest) {
    ...
    {   /// Key access
        ...
        if( !NOTDEBUG ) {
            ...
            QuESo_CHECK_EQUAL(r_mesh_settings.GetRequiredValue<GridType>(BackgroundGridSettings::grid_type), GridType::b_spline_grid);
            QuESo_CHECK_POINT_NEAR(r_mesh_settings.GetRequiredValue<PointType>(BackgroundGridSettings::lower_bound_xyz), PointType({1.0, 2.0, 3.0}), 1e-10);
            QuESo_CHECK_POINT_NEAR(r_mesh_settings.GetRequiredValue<PointType>(BackgroundGridSettings::upper_bound_xyz), PointType({1.0, 2.0, 3.0}), 1e-10);
            QuESo_CHECK_POINT_NEAR(r_mesh_settings.GetRequiredValue<PointType>(BackgroundGridSettings::lower_bound_uvw), PointType({1.0, 2.0, 3.0}), 1e-10);
            QuESo_CHECK_POINT_NEAR(r_mesh_settings.GetRequiredValue<PointType>(BackgroundGridSettings::upper_bound_uvw), PointType({1.0, 2.0, 3.0}), 1e-10);
            QuESo_CHECK_Vector3i_EQUAL(r_mesh_settings.GetRequiredValue<Vector3i>(BackgroundGridSettings::polynomial_order), Vector3i({1, 2, 3}));
            QuESo_CHECK_Vector3i_EQUAL(r_mesh_settings.GetRequiredValue<Vector3i>(BackgroundGridSettings::number_of_elements), Vector3i({1, 2, 3}));
        }
    }
    {   /// String access
...
BOOST_AUTO_TEST_CASE(SettingsCheckRequiredTest) {
    ...
    settings.GetList(MainSettings::conditions_settings_list)[0]->SetValue(ConditionSettings::input_filename, std::string("condition.stl"));
    settings.CheckRequired();
}
...
BOOST_AUTO_TEST_CASE(SettingsDefaultValuesTest) {
    ...
    {   /// Key access
        ...
        if( !NOTDEBUG ) {
            BOOST_REQUIRE_THROW( settings[MainSettings::background_grid_settings].GetRequiredValue<GridType>(BackgroundGridSettings::grid_type), std::exception );
            BOOST_REQUIRE_THROW( settings[MainSettings::background_grid_settings].GetRequiredValue<PointType>(BackgroundGridSettings::lower_bound_xyz), std::exception );
            BOOST_REQUIRE_THROW( settings[MainSettings::background_grid_settings].GetRequiredValue<PointType>(BackgroundGridSettings::upper_bound_xyz), std::exception );
            BOOST_REQUIRE_THROW( settings[MainSettings::background_grid_settings].GetRequiredValue<PointType>(BackgroundGridSettings::lower_bound_uvw), std::exception );
            BOOST_REQUIRE_THROW( settings[MainSettings::background_grid_settings].GetRequiredValue<PointType>(BackgroundGridSettings::upper_bound_uvw), std::exception );
            BOOST_REQUIRE_THROW( settings[MainSettings::background_grid_settings].GetRequiredValue<Vector3i>(BackgroundGridSettings::polynomial_order), std::exception );
            BOOST_REQUIRE_THROW( settings[MainSettings::background_grid_settings].GetRequiredValue<Vector3i>(BackgroundGridSettings::number_of_elements), std::exception );
        }
        settings[MainSettings::background_grid_settings].SetValue(BackgroundGridSettings::grid_type, GridType::b_spline_grid);
        settings[MainSettings::background_grid_settings].SetValue(BackgroundGridSettings::lower_bound_xyz, PointType({0.0, 0.0, 0.0}));
        settings[MainSettings::background_grid_settings].SetValue(BackgroundGridSettings::upper_bound_xyz, PointType({1.0, 1.0, 1.0}));
        ...
        QuESo_CHECK_RELATIVE_NEAR( settings[MainSettings::trimmed_quadrature_rule_settings].GetRequiredValue<double>(TrimmedQuadratureRuleSettings::moment_fitting_residual), 1e-10,1e-10 );
        ...
        QuESo_CHECK_RELATIVE_NEAR( settings[MainSettings::trimmed_quadrature_rule_settings].GetRequiredValue<double>(TrimmedQuadratureRuleSettings::min_element_volume_ratio), 1e-3,1e-10 );
        ...
        QuESo_CHECK_EQUAL( settings[MainSettings::trimmed_quadrature_rule_settings].GetRequiredValue<IndexType>(TrimmedQuadratureRuleSettings::min_num_boundary_triangles), 100 );
        ...
        QuESo_CHECK_EQUAL( settings[MainSettings::trimmed_quadrature_rule_settings].GetRequiredValue<bool>(TrimmedQuadratureRuleSettings::neglect_elements_if_stl_is_flawed), true );
        ...
        QuESo_CHECK_EQUAL( settings[MainSettings::non_trimmed_quadrature_rule_settings].GetRequiredValue<IntegrationMethod>(NonTrimmedQuadratureRuleSettings::integration_method), IntegrationMethod::gauss );
    }
    {   /// String access
        using DictionaryType = Dictionary<queso::key::MainValuesTypeTag>;
        using StringAccess = DictionaryStringAccess<DictionaryType>;
...
BOOST_AUTO_TEST_CASE(SettingsCustomizedValuesTest) {
    ...
    {   /// Key access
        ...
        QuESo_CHECK_EQUAL( settings[MainSettings::background_grid_settings].GetRequiredValue<PointType>(BackgroundGridSettings::upper_bound_xyz), PointType({0.0, 3.0, 2.0}) );
        QuESo_CHECK_EQUAL( settings[MainSettings::background_grid_settings].GetRequiredValue<PointType>(BackgroundGridSettings::lower_bound_uvw), PointType({0.1, -1.0, 2.0}) );
        QuESo_CHECK_EQUAL( settings[MainSettings::background_grid_settings].GetRequiredValue<PointType>(BackgroundGridSettings::upper_bound_uvw), PointType({0.66, 1.0, 2.2}) );
        QuESo_CHECK_EQUAL( settings[MainSettings::background_grid_settings].GetRequiredValue<Vector3i>(BackgroundGridSettings::polynomial_order), Vector3i({5, 6, 7}) );
        QuESo_CHECK_EQUAL( settings[MainSettings::background_grid_settings].GetRequiredValue<Vector3i>(BackgroundGridSettings::number_of_elements), Vector3i({8, 9, 2}) );
        ...
        QuESo_CHECK_RELATIVE_NEAR( settings[MainSettings::trimmed_quadrature_rule_settings].GetRequiredValue<double>(TrimmedQuadratureRuleSettings::moment_fitting_residual), 5.6e-5, 1e-10 );
        QuESo_CHECK_RELATIVE_NEAR( settings[MainSettings::trimmed_quadrature_rule_settings].GetRequiredValue<double>(TrimmedQuadratureRuleSettings::min_element_volume_ratio), 0.45, 1e-10 );
        QuESo_CHECK_EQUAL( settings[MainSettings::trimmed_quadrature_rule_settings].GetRequiredValue<IndexType>(TrimmedQuadratureRuleSettings::min_num_boundary_triangles), 234u );
        QuESo_CHECK_EQUAL( settings[MainSettings::trimmed_quadrature_rule_settings].GetRequiredValue<bool>(TrimmedQuadratureRuleSettings::neglect_elements_if_stl_is_flawed), false );
        ...
        QuESo_CHECK_EQUAL( settings[MainSettings::non_trimmed_quadrature_rule_settings].GetRequiredValue<IntegrationMethod>(NonTrimmedQuadratureRuleSettings::integration_method), IntegrationMethod::ggq_optimal );
    }
    {   /// String acccess
        using DictionaryType = Dictionary<queso::key::MainValuesTypeTag>;
        using StringAccess = DictionaryStringAccess<DictionaryType>;
...
BOOST_AUTO_TEST_CASE(SettingsConditionSettingsCustomizedValuesTest) {
    ...
    {   /// Key access
        ...
        }
        {
            ...
            QuESo_CHECK_EQUAL( r_cond_settings_list[0u]->GetRequiredValue<IndexType>(ConditionSettings::condition_id), 120u );

            QuESo_CHECK( r_cond_settings_list[0u]->IsSet(ConditionSettings::condition_type) );
            QuESo_CHECK_EQUAL( r_cond_settings_list[0u]->TryGetValue<std::string>(ConditionSettings::condition_type)->get(), std::string("Hello") );

            QuESo_CHECK( r_cond_settings_list[0u]->IsSet(ConditionSettings::input_filename) );
            QuESo_CHECK_EQUAL( r_cond_settings_list[0u]->GetRequiredValue<std::string>(ConditionSettings::input_filename), std::string("hallo") );

            QuESo_CHECK( r_cond_settings_list[0u]->IsSet(ConditionSettings::modulus) );
            QuESo_CHECK_EQUAL( r_cond_settings_list[0u]->TryGetValue<double>(ConditionSettings::modulus)->get(), 200.0 );

            QuESo_CHECK( !r_cond_settings_list[0u]->IsSet(ConditionSettings::direction) );
            QuESo_CHECK( !r_cond_settings_list[0u]->TryGetValue<PointType>(ConditionSettings::direction).has_value() );
            ...
            QuESo_CHECK_EQUAL( r_cond_settings_list[0u]->TryGetValue<double>(ConditionSettings::penalty_factor)->get(), 300.0 );
        }
        {
            auto& r_cond_settings_list = p_settingss->GetList(MainSettings::conditions_settings_list);
            QuESo_CHECK_EQUAL( r_cond_settings_list.size(), 2 );
            ...
            QuESo_CHECK_EQUAL( r_cond_settings_list[1u]->GetRequiredValue<IndexType>(ConditionSettings::condition_id), 150u );

            QuESo_CHECK( r_cond_settings_list[1u]->IsSet(ConditionSettings::condition_type) );
            QuESo_CHECK_EQUAL( r_cond_settings_list[1u]->TryGetValue<std::string>(ConditionSettings::condition_type)->get(), std::string("Hello2") );

            QuESo_CHECK( r_cond_settings_list[1u]->IsSet(ConditionSettings::input_filename) );
            QuESo_CHECK_EQUAL( r_cond_settings_list[1u]->GetRequiredValue<std::string>(ConditionSettings::input_filename), std::string("hallo2") );
            ...
            QuESo_CHECK_POINT_NEAR( r_cond_settings_list[1u]->TryGetValue<PointType>(ConditionSettings::direction)->get(), PointType({2.1, 3.2, 4.7}), 1e-10 );

            QuESo_CHECK( r_cond_settings_list[1u]->IsSet(ConditionSettings::value) );
            QuESo_CHECK_POINT_NEAR( r_cond_settings_list[1u]->TryGetValue<PointType>(ConditionSettings::value)->get(), PointType({2.2, 2.3, 1.4}), 1e-10 );

            QuESo_CHECK( !r_cond_settings_list[1u]->IsSet(ConditionSettings::penalty_factor) );
            QuESo_CHECK( !r_cond_settings_list[1u]->TryGetValue<double>(ConditionSettings::penalty_factor).has_value() );
        }
    }
    {   /// String access
        using DictionaryType = Dictionary<queso::key::MainValuesTypeTag>;

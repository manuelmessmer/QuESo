...
namespace Testing {
    ...
    BOOST_AUTO_TEST_CASE(ModelInfoDefaultValuesTest)
    {
        ...
        {  /// Key access
            ...
            QuESo_CHECK(
                !r_model_info[MainInfo::quadrature_info].IsSet(QuadratureInfo::num_of_points_per_trimmed_element)
            );
            ...
            if (!NOTDEBUG) {
                BOOST_REQUIRE_THROW(
                    r_model_info[MainInfo::embedded_geometry_info].GetRequiredValue<bool>(
                        EmbeddedGeometryInfo::is_closed
                    ),
                    std::exception
                );
                BOOST_REQUIRE_THROW(
                    r_model_info[MainInfo::embedded_geometry_info].GetRequiredValue<double>(
                        EmbeddedGeometryInfo::volume
                    ),
                    std::exception
                );
                BOOST_REQUIRE_THROW(
                    r_model_info[MainInfo::quadrature_info].GetRequiredValue<double>(
                        QuadratureInfo::represented_volume
                    ),
                    std::exception
                );
                BOOST_REQUIRE_THROW(
                    r_model_info[MainInfo::quadrature_info].GetRequiredValue<double>(
                        QuadratureInfo::percentage_of_geometry_volume
                    ),
                    std::exception
                );
                BOOST_REQUIRE_THROW(
                    r_model_info[MainInfo::quadrature_info].GetRequiredValue<IndexType>(QuadratureInfo::tot_num_points),
                    std::exception
                );
                BOOST_REQUIRE_THROW(
                    r_model_info[MainInfo::quadrature_info].GetRequiredValue<double>(
                        QuadratureInfo::num_of_points_per_full_element
                    ),
                    std::exception
                );
                BOOST_REQUIRE_THROW(
                    r_model_info[MainInfo::quadrature_info].GetRequiredValue<double>(
                        QuadratureInfo::num_of_points_per_trimmed_element
                    ),
                    std::exception
                );
                BOOST_REQUIRE_THROW(
                    r_model_info[MainInfo::background_grid_info].GetRequiredValue<IndexType>(
                        BackgroundGridInfo::num_active_elements
                    ),
                    std::exception
                );
                BOOST_REQUIRE_THROW(
                    r_model_info[MainInfo::background_grid_info].GetRequiredValue<IndexType>(
                        BackgroundGridInfo::num_trimmed_elements
                    ),
                    std::exception
                );
                BOOST_REQUIRE_THROW(
                    r_model_info[MainInfo::background_grid_info].GetRequiredValue<IndexType>(
                        BackgroundGridInfo::num_full_elements
                    ),
                    std::exception
                );
                BOOST_REQUIRE_THROW(
                    r_model_info[MainInfo::background_grid_info].GetRequiredValue<IndexType>(
                        BackgroundGridInfo::num_inactive_elements
                    ),
                    std::exception
                );
            }
            ...
            if (!NOTDEBUG) {
                BOOST_REQUIRE_THROW(
                    r_elpased_time_info.GetRequiredValue<IndexType>(ConditionInfo::condition_id), std::exception
                );  // Wrong key
                BOOST_REQUIRE_THROW(
                    r_elpased_time_info.GetRequiredValue<double>(ConditionInfo::surf_area), std::exception
                );  // Wrong key
            }
            ...
            if (!NOTDEBUG) {  // Wrong key type
                BOOST_REQUIRE_THROW(
                    r_volume_time_info.GetRequiredValue<IndexType>(ConditionInfo::condition_id), std::exception
                );
            }
            QuESo_CHECK(r_volume_time_info.IsSet(VolumeTimeInfo::classification_of_elements));
            QuESo_CHECK_NEAR(
                r_volume_time_info.GetRequiredValue<double>(VolumeTimeInfo::classification_of_elements), 0.0, EPS0
            );
            if (!NOTDEBUG) {  // Wrong key type
                BOOST_REQUIRE_THROW(
                    r_volume_time_info.GetRequiredValue<double>(ConditionsTimeInfo::total), std::exception
                );
            }
            QuESo_CHECK(r_volume_time_info.IsSet(VolumeTimeInfo::computation_of_intersections));
            QuESo_CHECK_NEAR(
                r_volume_time_info.GetRequiredValue<double>(VolumeTimeInfo::computation_of_intersections), 0.0, EPS0
            );
            QuESo_CHECK(r_volume_time_info.IsSet(VolumeTimeInfo::solution_of_moment_fitting_eqs));
            QuESo_CHECK_NEAR(
                r_volume_time_info.GetRequiredValue<double>(VolumeTimeInfo::solution_of_moment_fitting_eqs), 0.0, EPS0
            );

            QuESo_CHECK(r_volume_time_info.IsSet(VolumeTimeInfo::construction_of_ggq_rules));
            QuESo_CHECK_NEAR(
                r_volume_time_info.GetRequiredValue<double>(VolumeTimeInfo::construction_of_ggq_rules), 0.0, EPS0
            );
        ...
        {  /// String access
            ...
            BOOST_REQUIRE_THROW(
                StringAccess::GetValue<double>(r_quadrature_info, "represented_volume"), std::exception
            );
            QuESo_CHECK(!StringAccess::IsSet(r_quadrature_info, "percentage_of_geometry_volume"));
            BOOST_REQUIRE_THROW(
                StringAccess::GetValue<double>(r_quadrature_info, "percentage_of_geometry_volume"), std::exception
            );
            ...
            BOOST_REQUIRE_THROW(
                StringAccess::GetValue<double>(r_quadrature_info, "num_of_points_per_full_element"), std::exception
            );
            QuESo_CHECK(!StringAccess::IsSet(r_quadrature_info, "num_of_points_per_trimmed_element"));
            BOOST_REQUIRE_THROW(
                StringAccess::GetValue<double>(r_quadrature_info, "num_of_points_per_trimmed_element"), std::exception
            );
            ...
            BOOST_REQUIRE_THROW(
                StringAccess::GetValue<IndexType>(r_background_grid_info, "num_active_elements"), std::exception
            );
            QuESo_CHECK(!StringAccess::IsSet(r_background_grid_info, "num_trimmed_elements"));
            BOOST_REQUIRE_THROW(
                StringAccess::GetValue<IndexType>(r_background_grid_info, "num_trimmed_elements"), std::exception
            );
            QuESo_CHECK(!StringAccess::IsSet(r_background_grid_info, "num_full_elements"));
            BOOST_REQUIRE_THROW(
                StringAccess::GetValue<IndexType>(r_background_grid_info, "num_full_elements"), std::exception
            );
            QuESo_CHECK(!StringAccess::IsSet(r_background_grid_info, "num_inactive_elements"));
            BOOST_REQUIRE_THROW(
                StringAccess::GetValue<IndexType>(r_background_grid_info, "num_inactive_elements"), std::exception
            );
            ...
            BOOST_REQUIRE_THROW(
                StringAccess::GetValue<IndexType>(r_elpased_time_info, "total"), std::exception
            );  // Wrong type
            BOOST_REQUIRE_THROW(
                StringAccess::GetValue<double>(r_elpased_time_info, "total2"), std::exception
            );  // Wrong key
            ...
            BOOST_REQUIRE_THROW(
                StringAccess::GetValue<IndexType>(r_volume_time_info, "total"), std::exception
            );  // Wrong type

            QuESo_CHECK(StringAccess::IsSet(r_volume_time_info, "classification_of_elements"));
            QuESo_CHECK_NEAR(
                StringAccess::GetValue<double>(r_volume_time_info, "classification_of_elements"), 0.0, EPS0
            );
            BOOST_REQUIRE_THROW(
                StringAccess::GetValue<IndexType>(r_volume_time_info, "classification_of_elements"), std::exception
            );  // Wrong type

            QuESo_CHECK(StringAccess::IsSet(r_volume_time_info, "computation_of_intersections"));
            QuESo_CHECK_NEAR(
                StringAccess::GetValue<double>(r_volume_time_info, "computation_of_intersections"), 0.0, EPS0
            );
            BOOST_REQUIRE_THROW(
                StringAccess::GetValue<IndexType>(r_volume_time_info, "computation_of_intersections"), std::exception
            );  // Wrong type

            QuESo_CHECK(StringAccess::IsSet(r_volume_time_info, "solution_of_moment_fitting_eqs"));
            QuESo_CHECK_NEAR(
                StringAccess::GetValue<double>(r_volume_time_info, "solution_of_moment_fitting_eqs"), 0.0, EPS0
            );
            BOOST_REQUIRE_THROW(
                StringAccess::GetValue<IndexType>(r_volume_time_info, "solution_of_moment_fitting_eqs"), std::exception
            );  // Wrong type

            QuESo_CHECK(StringAccess::IsSet(r_volume_time_info, "construction_of_ggq_rules"));
            QuESo_CHECK_NEAR(
                StringAccess::GetValue<double>(r_volume_time_info, "construction_of_ggq_rules"), 0.0, EPS0
            );
            BOOST_REQUIRE_THROW(
                StringAccess::GetValue<IndexType>(r_volume_time_info, "construction_of_ggq_rules"), std::exception
            );  // Wrong type
            ...
            BOOST_REQUIRE_THROW(
                StringAccess::GetValue<IndexType>(r_conditions_time_info, "total"), std::exception
            );  // Wrong type

            /// write_files_time_info
            auto& r_write_files_time_info =
                StringAccess::GetSubDictionary(r_elpased_time_info, "write_files_time_info");
            ...
            BOOST_REQUIRE_THROW(
                StringAccess::GetValue<IndexType>(r_write_files_time_info, "total"), std::exception
            );  // Wrong type
        }
    }
    ...
    BOOST_AUTO_TEST_CASE(ModelInfoCustomizedValuesTest)
    {
        ...
        {  /// Key access
            ...
            QuESo_CHECK_NEAR(
                r_embedded_geometry_info.GetRequiredValue<double>(EmbeddedGeometryInfo::volume), 2.0, EPS2
            );
            ...
            QuESo_CHECK_NEAR(
                r_quadrature_info.GetRequiredValue<double>(QuadratureInfo::percentage_of_geometry_volume), 5.0, EPS2
            );
            ...
            QuESo_CHECK_NEAR(
                r_quadrature_info.GetRequiredValue<double>(QuadratureInfo::num_of_points_per_full_element), 5.5, EPS2
            );
            QuESo_CHECK(r_quadrature_info.IsSet(QuadratureInfo::num_of_points_per_trimmed_element));
            QuESo_CHECK_NEAR(
                r_quadrature_info.GetRequiredValue<double>(QuadratureInfo::num_of_points_per_trimmed_element), 3.3, EPS2
            );
            ...
            QuESo_CHECK_EQUAL(
                r_background_grid_info.GetRequiredValue<IndexType>(BackgroundGridInfo::num_active_elements), 5
            );
            QuESo_CHECK(r_background_grid_info.IsSet(BackgroundGridInfo::num_trimmed_elements));
            QuESo_CHECK_EQUAL(
                r_background_grid_info.GetRequiredValue<IndexType>(BackgroundGridInfo::num_trimmed_elements), 7
            );
            QuESo_CHECK(r_background_grid_info.IsSet(BackgroundGridInfo::num_full_elements));
            QuESo_CHECK_EQUAL(
                r_background_grid_info.GetRequiredValue<IndexType>(BackgroundGridInfo::num_full_elements), 101
            );
            QuESo_CHECK(r_background_grid_info.IsSet(BackgroundGridInfo::num_inactive_elements));
            QuESo_CHECK_EQUAL(
                r_background_grid_info.GetRequiredValue<IndexType>(BackgroundGridInfo::num_inactive_elements), 52
            );
            ...
            r_elapsed_time_info[ElapsedTimeInfo::volume_time_info].SetValue(
                VolumeTimeInfo::classification_of_elements, 122.2
            );
            r_elapsed_time_info[ElapsedTimeInfo::volume_time_info].SetValue(
                VolumeTimeInfo::computation_of_intersections, 44.5
            );
            r_elapsed_time_info[ElapsedTimeInfo::volume_time_info].SetValue(
                VolumeTimeInfo::solution_of_moment_fitting_eqs, 33.2
            );
            r_elapsed_time_info[ElapsedTimeInfo::volume_time_info].SetValue(
                VolumeTimeInfo::construction_of_ggq_rules, 2.23
            );
            ...
            QuESo_CHECK_NEAR(
                r_elapsed_time_info[ElapsedTimeInfo::volume_time_info].GetRequiredValue<double>(VolumeTimeInfo::total),
                12.2,
                EPS2
            );
            QuESo_CHECK(
                r_elapsed_time_info[ElapsedTimeInfo::volume_time_info].IsSet(VolumeTimeInfo::classification_of_elements)
            );
            QuESo_CHECK_NEAR(
                r_elapsed_time_info[ElapsedTimeInfo::volume_time_info].GetRequiredValue<double>(
                    VolumeTimeInfo::classification_of_elements
                ),
                122.2,
                EPS2
            );
            QuESo_CHECK(
                r_elapsed_time_info[ElapsedTimeInfo::volume_time_info].IsSet(
                    VolumeTimeInfo::computation_of_intersections
                )
            );
            QuESo_CHECK_NEAR(
                r_elapsed_time_info[ElapsedTimeInfo::volume_time_info].GetRequiredValue<double>(
            ...
            QuESo_CHECK(
                r_elapsed_time_info[ElapsedTimeInfo::volume_time_info].IsSet(
                    VolumeTimeInfo::solution_of_moment_fitting_eqs
                )
            );
            QuESo_CHECK_NEAR(
                r_elapsed_time_info[ElapsedTimeInfo::volume_time_info].GetRequiredValue<double>(
            ...
            QuESo_CHECK(
                r_elapsed_time_info[ElapsedTimeInfo::volume_time_info].IsSet(VolumeTimeInfo::construction_of_ggq_rules)
            );
            QuESo_CHECK_NEAR(
                r_elapsed_time_info[ElapsedTimeInfo::volume_time_info].GetRequiredValue<double>(
                    VolumeTimeInfo::construction_of_ggq_rules
                ),
                2.23,
                EPS2
            );
            ...
            QuESo_CHECK_NEAR(
                r_elapsed_time_info[ElapsedTimeInfo::conditions_time_info].GetRequiredValue<double>(
                    ConditionsTimeInfo::total
                ),
                1.123,
                EPS2
            );
            ...
            QuESo_CHECK_NEAR(
                r_elapsed_time_info[ElapsedTimeInfo::write_files_time_info].GetRequiredValue<double>(
                    WriteFilesTimeInfo::total
                ),
                5.123,
                EPS2
            );
        ...
        {  /// String access
            ...
            QuESo_CHECK(StringAccess::IsSet(r_quadrature_info, "percentage_of_geometry_volume"));
            QuESo_CHECK_NEAR(
                StringAccess::GetValue<double>(r_quadrature_info, "percentage_of_geometry_volume"), 5.0, EPS2
            );
            ...
            QuESo_CHECK(StringAccess::IsSet(r_quadrature_info, "num_of_points_per_full_element"));
            QuESo_CHECK_NEAR(
                StringAccess::GetValue<double>(r_quadrature_info, "num_of_points_per_full_element"), 5.5, EPS2
            );

            StringAccess::SetValue(r_quadrature_info, "num_of_points_per_trimmed_element", 3.3);
            QuESo_CHECK(StringAccess::IsSet(r_quadrature_info, "num_of_points_per_trimmed_element"));
            QuESo_CHECK_NEAR(
                StringAccess::GetValue<double>(r_quadrature_info, "num_of_points_per_trimmed_element"), 3.3, EPS2
            );
            ...
            QuESo_CHECK(StringAccess::IsSet(r_volume_time_info, "classification_of_elements"));
            QuESo_CHECK_NEAR(
                StringAccess::GetValue<double>(r_volume_time_info, "classification_of_elements"), 122.2, EPS2
            );

            StringAccess::SetValue(r_volume_time_info, "computation_of_intersections", 44.5);
            QuESo_CHECK(StringAccess::IsSet(r_volume_time_info, "computation_of_intersections"));
            QuESo_CHECK_NEAR(
                StringAccess::GetValue<double>(r_volume_time_info, "computation_of_intersections"), 44.5, EPS2
            );

            StringAccess::SetValue(r_volume_time_info, "solution_of_moment_fitting_eqs", 33.2);
            QuESo_CHECK(StringAccess::IsSet(r_volume_time_info, "solution_of_moment_fitting_eqs"));
            QuESo_CHECK_NEAR(
                StringAccess::GetValue<double>(r_volume_time_info, "solution_of_moment_fitting_eqs"), 33.2, EPS2
            );

            StringAccess::SetValue(r_volume_time_info, "construction_of_ggq_rules", 2.23);
            QuESo_CHECK(StringAccess::IsSet(r_volume_time_info, "construction_of_ggq_rules"));
            QuESo_CHECK_NEAR(
                StringAccess::GetValue<double>(r_volume_time_info, "construction_of_ggq_rules"), 2.23, EPS2
            );
            ...
            /// write_files_time_info
            auto& r_write_files_time_info =
                StringAccess::GetSubDictionary(r_elapsed_time_info, "write_files_time_info");
    ...
    BOOST_AUTO_TEST_CASE(ModelInfoConditionsInfoDefaultValuesTest)
    {
        ...
        {  /// Key access
            ...
            if (!NOTDEBUG) {
                BOOST_REQUIRE_THROW(
                    r_cond_info.GetRequiredValue<IndexType>(ConditionInfo::condition_id), std::exception
                );
                BOOST_REQUIRE_THROW(r_cond_info.GetRequiredValue<double>(ConditionInfo::surf_area), std::exception);
                BOOST_REQUIRE_THROW(
                    r_cond_info.GetRequiredValue<double>(ConditionInfo::perc_surf_area_in_active_domain), std::exception
                );
            }
        }
        {  /// String access
            ...
            BOOST_REQUIRE_THROW(
                StringAccess::GetValue<double>(r_cond_info, "perc_surf_area_in_active_domain"), std::exception
            );
        }
    };
    ...
    BOOST_AUTO_TEST_CASE(ModelInfoConditionsInfoCustomizedValuesTest)
    {
        ...
        {  /// Key access
...

            {
                ...
                QuESo_CHECK(r_cond_info.IsSet(ConditionInfo::perc_surf_area_in_active_domain));
                QuESo_CHECK_NEAR(
                    r_cond_info.GetRequiredValue<double>(ConditionInfo::perc_surf_area_in_active_domain), 223.1, EPS2
                );
        ...
        {  /// String access
            ...
            auto p_model_info = DictionaryFactory<queso::key::MainValuesTypeTag>::Create("ComponentInfo");
            {
                ...
                QuESo_CHECK(StringAccess::IsSet(r_cond_info, "perc_surf_area_in_active_domain"));
                QuESo_CHECK_NEAR(
                    StringAccess::GetValue<double>(r_cond_info, "perc_surf_area_in_active_domain"), 223.1, EPS2
                );

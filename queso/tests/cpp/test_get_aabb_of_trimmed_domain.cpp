...
namespace Testing {
    ...
    BOOST_AUTO_TEST_CASE(CylinderBoundingBoxOfTrimmedDomainTest)
    {
        ...
        std::ifstream myfile(base_dir + "/embedding/aabb_trimmed_domain_cylinder.txt");
        std::string line;
    ...
    BOOST_AUTO_TEST_CASE(CubeBoundingBoxOfTrimmedDomainTest)
    {
        ...
        std::ifstream myfile(base_dir + "/embedding/aabb_trimmed_domain_cube.txt");
        std::string line;
        for (IndexType i = 0; i < results.size(); ++i) {
            getline(myfile, line);
            double ref_value = std::stod(line);
    ...
    BOOST_AUTO_TEST_CASE(ElephantBoundingBoxOfTrimmedDomainTest)
    {
        ...
        std::ifstream myfile(base_dir + "/embedding/aabb_trimmed_domain_elephant.txt");
        std::string line;
        for (IndexType i = 0; i < results.size(); ++i) {
            getline(myfile, line);
            double ref_value = std::stod(line);
    ...
    BOOST_AUTO_TEST_CASE(BunnyBoundingBoxOfTrimmedDomainTest)
    {
        ...
        std::ifstream myfile(base_dir + "/embedding/aabb_trimmed_domain_bunny.txt");
        std::string line;
        for (IndexType i = 0; i < results.size(); ++i) {
            getline(myfile, line);
            double ref_value = std::stod(line);
